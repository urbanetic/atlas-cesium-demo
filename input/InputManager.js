define([
  ...
  InputManager.prototype.createDefaultBinds = function () {
    ...
    this._screenSpaceEventHandler.setInputAction(function(movement) {
      ...
      this.handleInternalEvent('input/leftmove', args);
    }.bind(this._atlasManagers.event), ScreenSpaceEventType.LEFT_MOVE);
    ...
    this._screenSpaceEventHandler.setInputAction(function(movement) {
      ...
      this.handleInternalEvent('input/rightmove', args);
    }.bind(this._atlasManagers.event), ScreenSpaceEventType.RIGHT_MOVE);
